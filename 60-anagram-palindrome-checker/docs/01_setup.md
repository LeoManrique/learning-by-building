...
- Run `make build`, then `make e2e`. All 8 tests should fail — that's the finish line for the project, not a problem to fix now.

**Done when:**

- [ ] `make e2e` builds your binary and reports failures against it.
